...
Each week, your instructor will add instructions for that week’s Challenge assignment to the class repo and announce that it’s ready. Your instructors and TAs will also provide a demonstration of the challenge in the classroom.
...
On-the-job ticket challenge will provide you with starter code in a folder called `Develop`. You’ll modify or add to this code to complete the challenge. Odd-numbered units follow this format.
